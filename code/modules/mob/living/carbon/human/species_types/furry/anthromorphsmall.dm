...
/datum/species/anthromorphsmall
	name = "Verminvolk"
	id = "anthromorphsmall"
	desc = "A race akin to wild-kin, except afflicted with significantly smaller stature. A bit less respected than their kin due to their closer resemblance to vermin, like the dichotomy between Kobold and Saurian.<br>\
	(+1 Speed)"
	default_color = "444"
	species_traits = list(
		MUTCOLORS,
