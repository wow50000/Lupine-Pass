/datum/advclass/tracker
	...
	outfit = /datum/outfit/job/roguetown/refugee/tracker
...
/datum/outfit/job/roguetown/refugee/tracker/pre_equip(mob/living/carbon/human/H)
	..()
	...
	H.adjust_skillrank(/datum/skill/labor/lumberjacking, 2, TRUE)//to build your little hunting lodge
	H.adjust_skillrank(/datum/skill/craft/carpentry, 2, TRUE)


/datum/advclass/tracker/spear
	name = "Spear-Hunter"
	tutorial = "You are a hunter. With your bow you hunt the fauna of the glade, skinning what you kill and cooking any meat left over. The job is dangerous but important in the circulation of clothing and light armor."
	outfit = /datum/outfit/job/roguetown/refugee/tracker_spear
	subclass_stats = list(
		STATKEY_STR = 2,
		STATKEY_CON = 1,
		STATKEY_WIL = 1
...
/datum/outfit/job/roguetown/refugee/tracker_spear/pre_equip(mob/living/carbon/human/H)
	..()
