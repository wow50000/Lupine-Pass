...
/datum/component/collar_master/proc/start_domination(mob/living/carbon/human/pet, mob/living/carbon/human/master)
...
/datum/component/collar_master/proc/end_domination()
...
/datum/component/collar_master/proc/verify_domination_end(mob/living/carbon/human/pet, mob/living/carbon/human/master, datum/mind/original_pet_mind, datum/mind/original_master_mind)
    if(!pet || !master)
        return
