...
/datum/preferences/proc/SetChoices(mob/user, limit = 14, list/splitJobs = list(TITLE_VALA, "Knight Captain", "Bishop", "Merchant", "Archivist", TITLE_SMIOR, "Grenzelhoft Mercenary", "Beggar", "Prisoner", "Goblin King"), widthPerColumn = 295, height = 620) //295 620
	if(!SSjob)
		return
