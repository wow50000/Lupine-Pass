...
/datum/sex_action/vaginal_sex/on_perform(mob/living/carbon/human/species/user, mob/living/carbon/human/target)
...
/datum/sex_action/vaginal_sex/knot/on_perform(mob/living/carbon/human/species/user, mob/living/carbon/human/target)
